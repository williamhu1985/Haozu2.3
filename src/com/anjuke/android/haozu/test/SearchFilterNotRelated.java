...
public class SearchFilterNotRelated extends ActivityInstrumentationTestCase2<WelcomeActivity> {
	private Solo solo;
	private int count = 3;
	private String testName = "好租搜索页筛选条件筛选不关联测试用例";
   
	public SearchFilterNotRelated(){
...
//			//点击切换城市按钮
			...
			Action.scroolUpPage(solo, "搜索筛选不关联");
			solo.clickOnText("上海");
